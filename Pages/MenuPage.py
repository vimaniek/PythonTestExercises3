...
class MenuPage(BasePage):
    ...
    def click_registration_button(self):
        self._find_element_and_click(self.registration_button)

    def click_draggable_button(self):
        self._find_element_and_click(self.draggable_button)

    def click_droppable_button(self):
        self._find_element_and_click(self.droppable_button)

    def click_resizable_button(self):
        self._find_element_and_click(self.resizable_button)

    def click_selectable_button(self):
        self._find_element_and_click(self.selectable_button)

    def click_sortable_button(self):
        self._find_element_and_click(self.sortable_button)

    def click_accordion_button(self):
        self._find_element_and_click(self.accordion_button)

    def click_autocomplete_button(self):
        self._find_element_and_click(self.autocomplete_button)

    def click_datepicker_button(self):
        self._find_element_and_click(self.datepicker_button)

    def click_menu_button(self):
        self._find_element_and_click(self.menu_button)

    def click_slider_button(self):
        self._find_element_and_click(self.slider_button)

    def click_tabs_button(self):
        self._find_element_and_click(self.tabs_button)

    def click_tooltip_button(self):
        self._find_element_and_click(self.tooltip_button)

    def click_frames_and_windows_button(self):
        self._find_element_and_click(self.frames_and_windows_button)
